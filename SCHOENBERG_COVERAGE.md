...
- **Native score** - verified musical material is stored as structured note data and is playable in the lesson.
...
| --- | --- | --- | --- |
| S01 Form & phrase | Ch. I-II; Exs. 1-11 | Ex. 2e and Ex. 5a are **native scores**. Ex. 4c has **interactive source analysis** pending a verified full transcription. Exs. 5-11 have interactive source-analysis maps of Schoenberg's printed progression; the remaining native notation is still to be transcribed. | Phrase comparison, repair, and construction studies |
| S02 The motive | Ch. III; Exs. 12-29 | Ex. 12b is a **native score**. Exs. 12-29 are covered by interactive source-analysis maps following Schoenberg's stated categories and order. Full native notation remains pending for the other printed examples, especially the literature excerpts and multi-part examples. | Transformation and systematic broken-chord studies |
...
| S05 Completing the sentence | Ch. VIII; Exs. 52-61 | Ex. 52's printed analytical functions are reconstructed interactively; Exs. 53-61 have source maps for extension, sequence, inserted repetition, developing variation, reduction/residues and cadence. Full native multi-staff transcriptions are pending. | Continuation, sequence, liquidation and full-sentence studies |
