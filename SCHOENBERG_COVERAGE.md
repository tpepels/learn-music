...
| S04 Beginning the sentence | Ch. V; Exs. 35-41 | Ex. 35a now has a **native playable grand-staff score** of the complete excerpt printed by Schoenberg, including pickup, tonic-form phrase, dominant-form answer, simultaneous accompaniment chords and triplet detail. Exs. 35-41 retain interactive source analysis for the broader comparisons. Native notation for 35b and Exs. 36-41 is still pending where the printed examples require piano, quartet or denser multi-voice notation. | Sentence-opening and tonic/dominant application studies |
