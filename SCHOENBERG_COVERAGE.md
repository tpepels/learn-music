...
| S11 Small ternary form | Ch. XIII; Exs. 101-107 | **Interactive source analysis** covers the three-part A-B-A′ relation, coherent contrast in the middle section, preparation of the return, and modification of the recapitulation. The printed examples remain pending for verified native transcription. | Departure/return listening, contrasting-middle design, modified recapitulation and a complete compact ternary form |
| S12 Uneven, irregular & asymmetrical construction | Ch. XIV; Exs. 108-112 | **Interactive source analysis** covers uneven totals, unequal formal units, asymmetrical division, internal repetition/extension and the requirement that irregularity remain balanced and fluent. Native notation for the examples remains pending. | Unequal activity, off-centre punctuation, motivic extension and a balanced irregular phrase |
| S13 Minuet | Ch. XV; Exs. 113-119 | **Interactive source analysis** covers moderate triple-metre character, harmonic pace, larger minuet-trio-return form and the contrasting role of the trio. No unverified notation or literal 3/4 reduction is invented in the current workspaces. | Measured melodic character, harmonic pacing, trio contrast and complete minuet-trio-return design |
| S14 Scherzo | Ch. XVI; Exs. 120-123 | **Interactive source analysis** covers rapid instrumental character, slower underlying harmonic motion, modulatory/developmental middle sections, liquidation, preparation of the return, reconstructed recapitulation, extensions and coda. Native source notation remains pending. | Strong thematic profile, mobile middle-section harmony, liquidation toward return, and recapitulation/coda design |
| S15 Theme & variations | Ch. XVII; Exs. 124-127 | **Interactive source analysis** covers structural constitution of the theme, the motive of variation, preservation of structural relations, sketching alternatives and organization of the complete set. No source melody or variation notation is fabricated. | Transformable theme, systematic variation motive, character/texture variation and ordering a set of contrasting variations |
| S16 Transitions, retransitions & codas | Ch. XVIII | **Interactive source analysis** covers transition as directed harmonic motion with establishment, modulation, liquidation and upbeat preparation; retransition as preparation for principal return; subordinate-group contrast and loose construction; and coda as an optional closing addition after essential balance is restored. The literature illustrations remain pending for verified native transcription. | Functional harmonic transition, motivic liquidation, subordinate-group contrast and reduced closing design |
| S17 Rondo forms | Ch. XIX | **Interactive source analysis** covers recurrence separated by contrast, varied principal-theme returns, adaptation of subordinate material in recapitulation, large rondo design and the developmental middle of sonata-rondo. No source melody is invented for the literature examples. | Refrain/episode macro form, varied return, adapted subordinate material and a compressed sonata-rondo relation |
| S18 Sonata-allegro | Ch. XX | **Interactive source analysis** covers exposition functions, thematic elaboration in roving regions, retransition, recapitulation and coda. Dense literature examples remain untranscribed; the application studies model formal functions without claiming to reproduce any source score. | Eight-bar exposition map, motivic working-out, dominant retransition and a four-block stability-instability-preparation-return model |
