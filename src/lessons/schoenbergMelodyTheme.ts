  ...
  exercises: [
    ...
    },
    {
      ...exerciseContentSchema.parse({
        ...
        instruction:
          "For this exercise, finish the current line as a self-contained melody rather than an open theme. Keep at least eight sounding notes, preserve the wave you developed, and make the final sounding note C, E or G so the ending has a stable relation to the current C-major context.\n\nMake at least four fresh edits and listen to the whole phrase. Then read the Melody versus Theme source map again and imagine removing the closing gesture. Notice how quickly a self-contained melody can become material that demands continuation when its resting point disappears.",
        recognition:
